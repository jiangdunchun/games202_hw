...
int main() {
    ...
    //test
    //std::string example_path = "E:/jdc_code/games202/games202_hw/hw_5/";

    // Box
    filesystem::path inputDir(example_path + "examples/box/input");
    filesystem::path outputDir(example_path + "examples/box/output");
    int frameNum = 20;

    
    // Pink room
    //filesystem::path inputDir(example_path + "examples/pink-room/input");
    //filesystem::path outputDir(example_path + "examples/pink-room/output");
    //int frameNum = 80;
